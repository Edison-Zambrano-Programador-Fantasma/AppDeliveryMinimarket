...
class OrdersProvider{
  ...
  Future<List<Order>> getByStatus(String status) async {
    try{
      ...
      final data= json.decode(res.body);// obteniendo categorias
  ...
  Future<List<Order>> getByDeliveryAndStatus(String id_delivery, String status) async {
    try{
      print('SESION TOKEN:${sessionUser.sessionToken}');
      Uri url = Uri.http(_url, '$_api/findByDeliveryAndStatus/$id_delivery/$status');
      Map<String, String> headers ={
        'Content-type': 'application/json',
        'Authorization': sessionUser.sessionToken
      };
