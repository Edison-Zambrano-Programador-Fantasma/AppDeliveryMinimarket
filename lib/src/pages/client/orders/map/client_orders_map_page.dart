...
import 'package:flutter_delivery_app/src/pages/delivery/orders/map/delivery_orders_map_controller.dart';
...
class _ClientOrdersMapPageState extends State<ClientOrdersMapPage> {
  ...
  Widget _cardOrderInfo(){
    return Container(
      ...
      child: Column(
        children: [
          _listTileAddress(_con.order?.address?.neighborhood, 'Lugar', Icons.my_location),
