...
class ClientAddressMaptPage extends StatefulWidget {
  const ClientAddressMaptPage({Key key}) : super(key: key);

  @override
  _ClientAddressMaptPageState createState() => _ClientAddressMaptPageState();
}

class _ClientAddressMaptPageState extends State<ClientAddressMaptPage> {
  ...
  Widget _googleMaps(){
    return GoogleMap(
      ...
      myLocationButtonEnabled: false,// habilitar para una mejor presicion
