...
class _RestaurantOrdersDetailPageState extends State<RestaurantOrdersDetailPage> {
  ...
  Widget _textDescription(){
    return Container(
      ...
      child: Text(
         _con.order == 'PAGADO'?'Asignar repartidor' : 'Repartidor Asigando',
        style: TextStyle(
            ...
            children: [
              Container(
                ...
                child: DropdownButton(
                  ...
                  onChanged: (option){
                    setState(() {
                      print('Repartidor selecionado $option');
                      _con.idDelivery = option; // estableciendo valor selecionado por el usuario en la variable
                    });
                  },
                ),
              )
