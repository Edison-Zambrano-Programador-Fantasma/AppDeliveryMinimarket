...
import 'package:flutter_delivery_app/src/pages/client/address/map/client_address_map_page.dart';
...
import 'package:flutter_delivery_app/src/pages/client/payments/create/client_payments_status_page.dart';
import 'package:flutter_delivery_app/src/pages/client/products/list/client_products_list_page.dart';
import 'package:flutter_delivery_app/src/pages/client/update/client_update_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'client/address/map':(BuildContext context)=>ClientAddressMaptPage(),
